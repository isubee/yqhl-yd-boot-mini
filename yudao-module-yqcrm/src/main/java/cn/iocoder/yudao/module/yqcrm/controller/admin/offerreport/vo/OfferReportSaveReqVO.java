...
@Schema(description = "管理后台 - 要约报备新增/修改 Request VO")
@Data
public class OfferReportSaveReqVO {
    ...
    @Schema(description = "要约报备物料明细列表")
    private List<OfferReportItemDO> offerReportItems;
